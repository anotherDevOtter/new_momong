        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
              <h2 className="text-lg font-light tracking-wide text-black mb-6">기본 정보</h2>
              <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                <div>
                  <span className="text-gray-500 font-light">진행 코스</span>
                  <p className="text-black font-normal mt-1">{courseNames[selectedCourse]}</p>
                </div>
                <div>
                  <span className="text-gray-500 font-light">고객명</span>
                  <p className="text-black font-normal mt-1">{customerData.name}</p>
                </div>
                <div>
                  <span className="text-gray-500 font-light">연락처</span>
                  <p className="text-black font-normal mt-1">{customerData.phone}</p>
                </div>
                <div>
                  <span className="text-gray-500 font-light">직업</span>
                  <p className="text-black font-normal mt-1">
                    {customerData.occupation || '미입력'}
                  </p>
                </div>
                <div>
                  <span className="text-gray-500 font-light">연령대</span>
                  <p className="text-black font-normal mt-1">
                    {customerData.ageGroup || '미선택'}
                  </p>
                </div>
                <div>
                  <span className="text-gray-500 font-light">성별</span>
                  <p className="text-black font-normal mt-1">{customerData.gender || '미선택'}</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <h2 className="text-lg font-light tracking-wide text-black mb-4">이미지 성향 요약</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-normal text-black">선호 이미지 키워드</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {imagePreferenceData.preferredKeywords.length > 0 ? (
                    imagePreferenceData.preferredKeywords.map((keyword) => (
                      <span
                        key={keyword}
                        className="px-3 py-1.5 rounded-lg border border-black text-black text-xs font-light"
                      >
                        {keyword}
                      </span>
                    ))
                  ) : (
                    <span className="text-xs text-gray-400 font-light">선택 없음</span>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-sm font-normal text-gray-700">비선호 이미지 키워드</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {imagePreferenceData.dislikedKeywords.length > 0 ? (
                    imagePreferenceData.dislikedKeywords.map((keyword) => (
                      <span
                        key={keyword}
                        className="px-3 py-1.5 rounded-lg border border-gray-300 text-gray-500 text-xs font-light flex items-center gap-1"
                      >
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <h2 className="text-lg font-light tracking-wide text-black mb-4">패션 무드 방향</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <div className="flex items-center gap-2 mb-4">
                  <Check className="w-4 h-4 text-black" strokeWidth={2.5} />
                  <h3 className="text-sm font-normal text-black">선호 패션 키워드</h3>
                </div>
                <div className="flex flex-wrap gap-2">
                  {fashionPreferenceData.preferredStyles.length > 0 ? (
              ...
              <div className="bg-white rounded-xl p-5 border border-gray-200">
                <div className="flex items-center gap-2 mb-4">
                  <X className="w-4 h-4 text-gray-500" strokeWidth={2.5} />
                  <h3 className="text-sm font-normal text-gray-700">비선호 패션 키워드</h3>
                </div>
                <div className="flex flex-wrap gap-2">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-lg font-light tracking-wide text-black mb-4">
              디자인 제안 핵심 방향
            </h2>
            ...
            <div className="bg-black text-white rounded-2xl p-6">
              ...
              <div className="space-y-2">
                <p className="text-xs text-gray-300 font-light mb-3">제안 전략:</p>
