...
export const FORM: MItem[] = [
  ...
  { id: 'browshape', num:  3, title: '눈썹 형태',    l: '둥근',    r: '각진',       defaultPos: 0.70, vType: 'Cool',    defaultValue: '각진형',   tags: ['#선명한', '#각진', '#정돈된'], desc: '눈썹 산에 각이 있어 이목구비를 선명하게 정돈해 줍니다.', breakdown: [{ label: 'Cool', pct: 46 }, { label: 'Neutral', pct: 32 }, { label: 'Warm', pct: 22 }] },
